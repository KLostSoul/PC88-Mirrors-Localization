...
1190 TK$=CHR$(&H00E0)+CHR$(0)+CHR$(&H00E0)+CHR$(1)+CHR$(&H00E0)+CHR$(2)+CHR$(&H00E0)+CHR$(3)+CHR$(&H00E0)+CHR$(&H00FF)+CHR$(&H00E1)+CHR$(0)+CHR$(&H00E1)+CHR$(&H00F3):BM$=TK$:CMD WIDTH &HC78C,&H80,7:CMD KANJI BM$
1195 YY=&HD835:ISET X:
1200 BM$=TK$:CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1210 BM$=TK$:CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1214 BM$=TK$:CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1215 BM$=TK$:CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1216 BM$=TK$:CMD WIDTH &HF70A,&H80,7:CMD KANJI BM$
1217 GOSUB 5620
...
1254 '
1255 '
1260 GOSUB 5600:BM$=TK$:GOSUB 4010:GOSUB 4000
1261 CMD SCREEN 1:GOSUB 5600:GOSUB 4250:BM$=TK$:CMD WIDTH &HD6D7,&H80,7:CMD KANJI BM$:GOSUB 5620
1262 S$=INKEY$:IF S$="" THEN 1262
1263 IF S$="n" OR S$="N" THEN GOTO 1260
1264 IF S$="y" OR S$="Y" THEN GOTO 1268
1265 GOTO 1262
1268 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 5620
1270 CMD FOR &H0
1285 GOSUB 5600:BM$=TK$:GOSUB 4040
1286 GOSUB 4000
1290 RETURN
1298 '
1299 '
1300 GOSUB 5600:BM$=TK$:GOSUB 4050:BM$=TK$:GOSUB 4060:GOSUB 4000
...
1303 GOSUB 5600:BM$=TK$:GOSUB 4050:GOTO 1305
1304 GOSUB 5600:BM$=TK$:GOSUB 4050
1305 BM$=TK$:GOSUB 4060:GOSUB 5620
...
1320 GOSUB 5600:BM$=TK$:GOSUB 4010:GOSUB 5620
1330 CMD FOR &H0:
1370 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 5620
...
1410 GOSUB 5600:BM$=TK$:GOSUB 4010:GOSUB 5620
1420 CMD FOR &H1:
1450 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 5620
...
1580 '
1600 GOSUB 5600:BM$=TK$:GOSUB 4070:BM$=TK$:GOSUB 4071
1700 BM$=TK$:GOSUB 4080:GOSUB 4000
1900 '
1990 POKE &H92DC,1:CMD SET:GOSUB 5600:COLOR=(7,7):CMD SCREEN 0:CMD RUN "NO0"
1998 '
1999 '
2000 '
2010 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 4000
2020 POKE &H9088,0:CMD SET "A:":CMD PEEK &HF3FE,AA:CMD PEEK &HF3FF,AB
2025 IF AA=100 AND AB=101 THEN 2030
2026 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 4000:GOTO 2010
2030 GOSUB 5600:BM$=TK$:GOSUB 4020:SA=0:SB=0:GOSUB 4500
...
2395 '
2400 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 4000
2450 '
...
3015 '
3020 GOSUB 5600:BM$=TK$:GOSUB 4090:BM$=TK$:GOSUB 4072:GOSUB 5620
3050 S$=INKEY$:IF S$="" THEN 3050
3060 IF S$="y" OR S$="Y" THEN 3100
3070 IF S$="n" OR S$="N" THEN 3090
3080 GOTO 3050
3090 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 4000:GOTO 3000
3099 '
3100 '
3101 CMD READ &H1,&H31,&H8,&H4000:CMD PEEK &H4000,A:CMD PEEK &H4001,B
3102 IF A=ASC("I") AND B=ASC("P") THEN 3120
3105 GOSUB 5600:BM$=TK$:GOSUB 4010:GOSUB 5620
3110 CMD FOR &H1:
3120 '
3130 GOSUB 5600:BM$=TK$:GOSUB 4040:GOSUB 5620
3398 '
3400 GOSUB 6000
3499 '
3500 '
...
3999 '
4000 CMD SCREEN 0:BM$=TK$:CMD WIDTH &HF2B0,&H60,7:CMD KANJI BM$
4001 BM$=TK$:CMD WIDTH &HF710,&H60,2:CMD KANJI BM$:GOSUB 5620
...
4500 BM$=TK$:CMD WIDTH &HF2B0,&H60,7:CMD KANJI BM$
4501 BM$=TK$:CMD WIDTH &HF710,&H60,2:CMD KANJI BM$:GOSUB 5620:RETURN
4999 '
5400 '
...
9040 BM$=TK$:CMD WIDTH &HD6DF,&H60,7:CMD KANJI BM$:BM$=TK$:CMD WIDTH &HD6FF,&H60,7:CMD KANJI BM$
9050 BM$=TK$:CMD WIDTH &HDD1F,&H60,7:CMD KANJI BM$:BM$=TK$:CMD WIDTH &HDD3F,&H60,7:CMD KANJI BM$
9060 BM$=TK$:CMD WIDTH &HE35F,&H60,7:CMD KANJI BM$:BM$=TK$:CMD WIDTH &HE37C,&H60,7:CMD KANJI BM$
9100 CMD SCREEN 0:BM$=TK$:CMD WIDTH &HF709,&H60,7:CMD KANJI BM$
9110 GOSUB 5620
9120 CN=0:CM=3:DX=0
