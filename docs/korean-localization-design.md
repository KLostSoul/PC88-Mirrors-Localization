...
- 정식 빌드가 에뮬레이터 FDD용 2HD 공디스크 `disk1main.d88`과 `disk2game.d88`를 `korean_mirrors_tools/output`에 생성하도록 반영했다. 두 파일은 160개 트랙, 1,331,888바이트의 2HD D88 구조이며, 영문 패치 공디스크와 바이트 단위로 일치한다.
