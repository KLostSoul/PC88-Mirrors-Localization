...
1190 BM$="[[K500:00F,010,011,012,013,014]]":CMD WIDTH &HC78C,&H80,7:CMD KANJI BM$
1195 YY=&HD835:ISET X:
1200 BM$="[[K500:015,016,017,018,019,01A,01B]]":CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1210 BM$="[[K500:01C,01D,01E,01F,020,021,022]]":CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1214 BM$="[[K500:023,024,025,026,027,028,029]]":CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1215 BM$="[[K500:02A,02B,02C,02D]]":CMD WIDTH YY,&H80,7:CMD KANJI BM$:YY=YY+&H50*20
1216 BM$="[[K500:02E,02F,030,031,032,033,034,035,036,037,038,039,03A,03B,03C,03D,03E,03F,040,041,042,043,044,045,046,047,048,049,04A,04B,04C]]":CMD WIDTH &HF70A,&H80,7:CMD KANJI BM$
1217 GOSUB 5620
...
1254 '
1255 '
1260 GOSUB 5600:BM$="[[K500:04D,04E,04F,050,051,052,053,054,055,056,057,058,059,05A,05B,05C,05D,05E,05F]]":GOSUB 4010:GOSUB 4000
1261 CMD SCREEN 1:GOSUB 5600:GOSUB 4250:BM$="[[K500:060,061,062,063,064,065,066,067,068,069,06A,06B,06C,06D,06E,06F,070,071,072,073,074,075,076]]":CMD WIDTH &HD6D7,&H80,7:CMD KANJI BM$:GOSUB 5620
1262 S$=INKEY$:IF S$="" THEN 1262
1263 IF S$="n" OR S$="N" THEN GOTO 1260
1264 IF S$="y" OR S$="Y" THEN GOTO 1268
1265 GOTO 1262
1268 GOSUB 5600:BM$="[[K500:077,078,079,07A,07B,07C,07D,07E,07F,080,081,082,083,084,085,086,087,088,089,08A]]":GOSUB 4040:GOSUB 5620
1270 CMD FOR &H0
1285 GOSUB 5600:BM$="[[K500:08B,08C,08D,08E,08F,090,091,092]]":GOSUB 4040
1286 GOSUB 4000
1290 RETURN
1298 '
1299 '
1300 GOSUB 5600:BM$="[[K500:093,094,095,096,097,098,099,09A,09B,09C,09D,09E,09F,0A0,0A1,0A2,0A3,0A4,0A5,0A6,0A7,0A8,0A9,0AA,0AB]]":GOSUB 4050:BM$="[[K500:0AC,0AD,0AE,0AF,0B0,0B1,0B2,0B3,0B4,0B5,0B6,0B7,0B8,0B9,0BA,0BB,0BC,0BD,0BE,0BF,0C0,0C1,0C2]]":GOSUB 4060:GOSUB 4000
...
1303 GOSUB 5600:BM$="[[K500:0C3,0C4,0C5,0C6,0C7,0C8,0C9,0CA,0CB,0CC,0CD,0CE,0CF,0D0,0D1,0D2,0D3,0D4,0D5,0D6,0D7,0D8,0D9]]":GOSUB 4050:GOTO 1305
1304 GOSUB 5600:BM$="[[K500:0DA,0DB,0DC,0DD,0DE,0DF,0E0,0E1,0E2,0E3,0E4,0E5,0E6,0E7,0E8,0E9,0EA,0EB,0EC,0ED,0EE,0EF,0F0,0F1,0F2,0F3,0F4,0F5,0F6,0F7]]":GOSUB 4050
1305 BM$="[[K500:0F8,0F9,0FA,0FB,0FC,0FD,0FE,0FF,100]]":GOSUB 4060:GOSUB 5620
...
1320 GOSUB 5600:BM$="[[K500:101,102,103,104,105,106,107,108,109,10A,10B,10C,10D,10E]]":GOSUB 4010:GOSUB 5620
1330 CMD FOR &H0:
1370 GOSUB 5600:BM$="[[K500:10F,110,111,112,113,114,115,116,117,118,119,11A,11B,11C,11D,11E,11F,120,121,122,123]]":GOSUB 4040:GOSUB 5620
...
1410 GOSUB 5600:BM$="[[K500:124,125,126,127,128,129,12A,12B,12C,12D,12E,12F,130,131]]":GOSUB 4010:GOSUB 5620
1420 CMD FOR &H1:
1450 GOSUB 5600:BM$="[[K500:132,133,134,135,136,137,138,139,13A,13B,13C,13D,13E,13F,140,141,142,143,144,145,146]]":GOSUB 4040:GOSUB 5620
...
1580 '
1600 GOSUB 5600:BM$="[[K500:147,148,149,14A,14B,14C,14D,14E,14F,150,151,152,153,154,155,156,157,158]]":GOSUB 4070:BM$="[[K500:159,15A,15B,15C,15D,15E,15F,160,161,162,163,164,165,166,167,168,169,16A]]":GOSUB 4071
1700 BM$="[[K500:16B,16C,16D,16E,16F,170,171,172,173,174,175,176,177,178,179,17A,17B,17C,17D,17E,17F]]":GOSUB 4080:GOSUB 4000
1900 '
1990 POKE &H92DC,1:CMD SET:GOSUB 5600:COLOR=(7,7):CMD SCREEN 0:CMD RUN "NO0"
1998 '
1999 '
2000 '
2010 GOSUB 5600:BM$="[[K500:180,181,182,183,184,185,186,187,188,189,18A,18B,18C,18D,18E,18F,190,191,192]]":GOSUB 4040:GOSUB 4000
2020 POKE &H9088,0:CMD SET "A:":CMD PEEK &HF3FE,AA:CMD PEEK &HF3FF,AB
2025 IF AA=100 AND AB=101 THEN 2030
2026 GOSUB 5600:BM$="[[K500:193,194,195,196,197,198,199,19A,19B,19C,19D,19E,19F,1A0,1A1,1A2,1A3,1A4,1A5,1A6,1A7,1A8,1A9,1AA]]":GOSUB 4040:GOSUB 4000:GOTO 2010
2030 GOSUB 5600:BM$="[[K500:1AB,1AC,1AD,1AE,1AF,1B0,1B1,1B2,1B3,1B4,1B5,1B6,1B7,1B8,1B9]]":GOSUB 4020:SA=0:SB=0:GOSUB 4500
...
2050 BM$="[[K500:1BA,1BB,1BC,1BD,1BE,1BF]]":GOSUB 4091:GOTO 2031
2199 '
2200 RESTORE 7000
2210 READ A,B,C,D,E$:IF A=99 THEN 2260
2220 IF A=SA AND B=SB THEN 2270
2250 GOTO 2210
2260 SA=0:SB=0:BM$="[[K500:1C0,1C1,1C2,1C3,1C4,1C5,1C6]]":GOSUB 4091:GOTO 2031
2270 BM$="[[K500:1C7,1C8,1C9,1CA]]":GOSUB 4091:GOTO 2031
2395 '
2400 GOSUB 5600:BM$="[[K500:1CB,1CC,1CD,1CE,1CF,1D0,1D1,1D2,1D3,1D4,1D5,1D6,1D7,1D8,1D9,1DA]]":GOSUB 4040:GOSUB 4000
2450 '
...
3015 '
3020 GOSUB 5600:BM$="[[K500:1DB,1DC,1DD,1DE,1DF,1E0,1E1,1E2,1E3,1E4,1E5,1E6,1E7,1E8,1E9,1EA,1EB,1EC,1ED,1EE,1EF,1F0,1F1,1F2,1F3,000]]":GOSUB 4090:BM$="[[K500:001,002,003,004,005,006,007,008,009,00A,00B,00C,00D,00E,00F,010,011,012,013]]":GOSUB 4072:GOSUB 5620
3050 S$=INKEY$:IF S$="" THEN 3050
3060 IF S$="y" OR S$="Y" THEN 3100
3070 IF S$="n" OR S$="N" THEN 3090
3080 GOTO 3050
3090 GOSUB 5600:BM$="[[K500:014,015,016,017,018,019,01A,01B,01C,01D,01E,01F,020,021,022,023,024,025,026]]":GOSUB 4040:GOSUB 4000:GOTO 3000
3099 '
3100 '
3101 CMD READ &H1,&H31,&H8,&H4000:CMD PEEK &H4000,A:CMD PEEK &H4001,B
3102 IF A=ASC("I") AND B=ASC("P") THEN 3120
3105 GOSUB 5600:BM$="[[K500:027,028,029,02A,02B,02C,02D,02E,02F,030,031,032,033,034,035,036,037,038,039]]":GOSUB 4010:GOSUB 5620
3110 CMD FOR &H1:
3120 '
3130 GOSUB 5600:BM$="[[K500:03A,03B,03C,03D,03E,03F,040,041,042,043,044,045,046,047,048,049,04A,04B,04C,04D,04E]]":GOSUB 4040:GOSUB 5620
3398 '
3400 GOSUB 6000
3499 '
3500 '
...
3999 '
4000 CMD SCREEN 0:BM$="[[K500:04F,050,051,052,053,054,055,056,057,058,059,05A,05B,05C,05D,05E,05F,060,061,062]]":CMD WIDTH &HF2B0,&H60,7:CMD KANJI BM$
4001 BM$="[[K500:063,064,065,066,067,068,069,06A,06B,06C,06D,06E,06F,070,071,072,073]]":CMD WIDTH &HF710,&H60,2:CMD KANJI BM$:GOSUB 5620
...
4500 BM$="[[K500:074,075,076,077,078,079,07A,07B,07C,07D,07E,07F,080,081,082,083,084,085,086,087]]":CMD WIDTH &HF2B0,&H60,7:CMD KANJI BM$
4501 BM$="[[K500:088,089,08A,08B,08C,08D,08E,08F,090,091,092,093,094,095,096,097,098]]":CMD WIDTH &HF710,&H60,2:CMD KANJI BM$:GOSUB 5620:RETURN
4999 '
5400 '
...
9040 BM$="[[K500:099,09A,09B,09C,09D,09E,09F,0A0]]":CMD WIDTH &HD6DF,&H60,7:CMD KANJI BM$:BM$="[[K500:0A1,0A2,0A3,0A4,0A5]]":CMD WIDTH &HD6FF,&H60,7:CMD KANJI BM$
9050 BM$="[[K500:0A6,0A7,0A8,0A9,0AA]]":CMD WIDTH &HDD1F,&H60,7:CMD KANJI BM$:BM$="[[K500:0AB,0AC,0AD,0AE]]":CMD WIDTH &HDD3F,&H60,7:CMD KANJI BM$
9060 BM$="[[K500:0AF,0B0,0B1,0B2,0B3]]":CMD WIDTH &HE35F,&H60,7:CMD KANJI BM$:BM$="[[K500:0B4,0B5,0B6,0B7,0B8,0B9,0BA,0BB]]":CMD WIDTH &HE37C,&H60,7:CMD KANJI BM$
9100 CMD SCREEN 0:BM$="[[K500:0BC,0BD,0BE,0BF,0C0,0C1,0C2,0C3,0C4,0C5,0C6,0C7,0C8,0C9,0CA,0CB,0CC,0CD,0CE,0CF,0D0,0D1,0D2,0D3,0D4,0D5,0D6,0D7,0D8,0D9,0DA]]":CMD WIDTH &HF709,&H60,7:CMD KANJI BM$
9110 GOSUB 5620
9120 CN=0:CM=3:DX=0
